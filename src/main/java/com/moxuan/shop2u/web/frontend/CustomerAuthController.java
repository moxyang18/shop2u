...
public class CustomerAuthController {
		...
		if (userName != null && password != null) {
			...
			if (localAuth != null) {
				if (localAuth.getPersonInfo().getCustomerFlag() == 1) {
					...
					modelMap.put("success", false);
					modelMap.put("errMsg", "no access for non-customer");
				}
			} else {
				modelMap.put("success", false);
			...
			modelMap.put("success", false);
			modelMap.put("errMsg", "username and password cannot be empty");
		}
		return modelMap;
	}
	...
	private Map<String, Object> customerRegister(HttpServletRequest request) {
		...
		if (multipartResolver.isMultipart(request)) {
			...
			modelMap.put("success", false);
			modelMap.put("errMsg", "file uploaded cannot be void");
			return modelMap;
		}
		try {
		...
		if (localAuth != null && localAuth.getPassword() != null
			...
			modelMap.put("success", false);
			modelMap.put("errMsg", "please enter registration info");
		}
		return modelMap;
	}
	...
	private Map<String, Object> bindLocalAuth(HttpServletRequest request) {
		...
		if (userName != null && password != null && user != null
			...
			modelMap.put("success", false);
			modelMap.put("errMsg", "username and password cannot be empty空");
		}
		return modelMap;
	}
